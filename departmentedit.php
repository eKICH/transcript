...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Transcript Management System - Edit Department</title>
...
<h3 style="text-align: center; color: blue;">Edit Department Details</h3>
<form action="javascript:void(0)" id="ajax-form">
        <div class="row" style="margin-top:6vh">
            <div class="col col-md-4">
              <label for="studentname">Department ID</label>
              <input type="text" readonly class="form-control" id="newdepartmentid" name="newdepartmentid" value="<?php echo htmlspecialchars($pizza['department_id']); ?>">
            </div>
            <div class="col col-md-4">
              <label for="gender">Department Name</label>
              <input type="text" class="form-control" id="newdepartment" name="newdepartment" value="<?php echo htmlspecialchars($pizza['department_name']); ?>">
            </div>
            <div class="col col-md-4">
        ...
        <div class="row">
          ...
          <span>
            <p class="alert alert-success" id="show_message" style="display: none; color:green;">Department Updated Successfully</p>
