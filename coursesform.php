...
<html lang="en">
  <head>
    <title>Transcript - Course Registration</title>
     ...
     <script>
       ...
       $(document).ready(function(){
         $("#course").submit(function(event){
           ...
           var submit = $("#course-submit").val();

           $(".form-message").load("includes/course.inc.php", {
            level: level,
            cname: cname,
  ...
  <body id="course" style="background-color: #c0c0c0;">
    <h3 style=" color: blue; margin-top:3vh; margin-left:30vw;">ADD COURSE DETAILS</h3>
    <div class="container" style="margin-top: 2vh; margin-left: 10vw;">

      <form id="course" action="includes/course.inc.php" method="post" >
          <div class="row" style="margin-top:6vh">
            ...
            <button type="submit" name="course-submit" id="course-submit" class="btn btn-primary">Register Course</button>
